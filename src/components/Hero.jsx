export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] rounded-full bg-accent/5 blur-[100px]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.15] mb-6 text-slate-900">
              ...
              Hi, I'm <span className="text-primary">Kali Krishna</span>
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed">
              ...
              Detail-oriented QA Engineer with hands-on experience in manual and automation testing of web applications using Selenium, Python & PyTest. Passionate about ensuring high-quality, user-centric software through precise validation and automation.
